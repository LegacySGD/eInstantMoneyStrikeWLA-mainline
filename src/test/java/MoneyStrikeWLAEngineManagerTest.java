...
public class MoneyStrikeWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MoneyStrikeWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MoneyStrikeWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MoneyStrikeWLAIW/InitOutcome.xml").getDocumentElement();
